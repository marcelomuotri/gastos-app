  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput
        ...
        onFocus={() => setShowPicker(true)} // Muestra el picker cuando el TextInput está en foco
        onBlur={() => setShowPicker(false)} // Oculta el picker cuando el TextInput pierde el foco (opcional)
